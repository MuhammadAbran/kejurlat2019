        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand" href="{{url('/')}}">KEJURLAT 2019</a>
                </div>
...
<section  class="container features">
    ...
    <div class="row">
        ...
        <div class="col-md-6 text-center  wow zoomIn">
            <img src="{{ asset('master/img/landing/perspective.png') }}" alt="dashboard" class="img-responsive">
        </div>
    ...
    <div class="row features-block">
        ...
        <div class="col-lg-6 text-right wow fadeInRight">
            <img src="{{ asset('master/img/landing/dashboard.png') }}" alt="dashboard" class="img-responsive pull-right">
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-sm-4 wow fadeInLeft">
                <div class="team-member">
                    <img src="{{ asset('master/img/landing/avatar3.jpg') }}" class="img-responsive img-circle img-small" alt="">
            ...
            <div class="col-sm-4">
                <div class="team-member wow zoomIn">
                    <img src="{{ asset('master/img/landing/avatar1.jpg') }}" class="img-responsive img-circle" alt="">
            ...
            <div class="col-sm-4 wow fadeInRight">
                <div class="team-member">
                    <img src="{{ asset('master/img/landing/avatar2.jpg') }}" class="img-responsive img-circle img-small" alt="">
    ...
    <div class="container">
        ...
        <div class="row features-block">
            ...
            <div class="col-lg-6 text-right m-t-n-lg wow zoomIn">
                <img src="{{ asset('master/img/landing/iphone.jpg') }}" class="img-responsive" alt="dashboard">
            </div>
    ...
    <div class="container">
        ...
        <div class="row features-block">
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="" class="pull-left">
                        <img alt="image" src="{{ asset('master/img/landing/avatar3.jpg') }}">
                    </a>
            ...
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="" class="pull-left">
                        <img alt="image" src="{{ asset('master/img/landing/avatar1.jpg') }}">
                    </a>
                    <div class="media-body">
                        <div class="commens-name">
                            Andrew Williams
            ...
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="" class="pull-left">
                        <img alt="image" src="{{ asset('master/img/landing/avatar2.jpg') }}">
                    </a>
                    <div class="media-body">
                        <div class="commens-name">
                            Andrew Williams
