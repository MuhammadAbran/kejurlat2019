            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                            <img alt="image" class="img-circle" src="{{ asset('master/img/profile_small.jpg') }}" />
                             </span>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="{{ asset('master/img/a7.jpg') }}">
                                </a>
                                <div>
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="{{ asset('master/img/a4.jpg') }}">
                                </a>
                                <div>
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="{{ asset('master/img/profile.jpg') }}">
                                </a>
                                <div>
                ...
                <div>
                    ...
                    <div class="feed-element">
                        <a href="#" class="pull-left">
                            <img alt="image" class="img-circle" src="{{ asset('master/img/a1.jpg') }}">
                        </a>
                    ...
                    <div class="feed-element">
                        <a href="#" class="pull-left">
                            <img alt="image" class="img-circle" src="{{ asset('master/img/a2.jpg') }}">
                        </a>
                        <div class="media-body">
                    ...
                    <div class="feed-element">
                        <a href="#" class="pull-left">
                            <img alt="image" class="img-circle" src="{{ asset('master/img/a3.jpg') }}">
                        </a>
                        <div class="media-body">
                    ...
                    <div id="tab-1" class="tab-pane active">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="{{ asset('master/img/a1.jpg') }}">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="{{ asset('master/img/a2.jpg') }}">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="{{ asset('master/img/a3.jpg') }}">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="{{ asset('master/img/a4.jpg') }}">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="{{ asset('master/img/a8.jpg') }}">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="{{ asset('master/img/a7.jpg') }}">
                                    </div>
                                    <div class="media-body">
    ...
    @if (Session::has('msg'))
        ...
        <script>
            $(document).ready(function() {
               ...
               toastr.success('{{ Session::get('msg') }}', 'Berhasil!');
